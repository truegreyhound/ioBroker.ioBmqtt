...
/* 
    id      - a id (javascript.0.watering.garden.circuit.1.valve_state)
    pattern - a pattern (javascript.0.watering.garden.*)
*/
function does_id_match_pattern(id, pattern) {

    let result = id.match(pattern);
    
    return (result ? (result.length > 0) : false);

} // does_id_match_pattern()
...
exports.does_id_match_pattern = does_id_match_pattern;
